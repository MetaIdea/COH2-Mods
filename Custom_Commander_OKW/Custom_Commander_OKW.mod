				...
				<d2p1:anyType i:type="Folder">
					<Children>
						<d2p1:anyType i:type="BurnAttributes">
							<RelativeName>attributes_mod.xml</RelativeName>
						</d2p1:anyType>
					</Children>
		...
		<d2p1:anyType i:type="TableOfContents">
			...
			<Children>
				<d2p1:anyType i:type="BurnModInfo">
					<Dependencies />
					<Description>This is a fun mod with my favourite commander abilities. When using it disable all 3 commander slots for it to properly work.
...
[b][url=paypal.com/paypalme/burningsister] Donation [/url][/b]</Description>
					<Hidden>false</Hidden>
					<Name>Custom Commander OKW</Name>
				</d2p1:anyType>
				<d2p1:anyType i:type="BurnFile">
	...
	<Guid>cfe358d1-27ba-4498-b53e-46b08332549a</Guid>
	<IsExpanded>false</IsExpanded>
